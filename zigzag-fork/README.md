...
| **Tiled Matrix Multiplication 12**<br />```sh zigzag-spike-build-and-run.sh tiledMatmul12.mlir```<br /><br />Dispatches to compute core!<br />Uses L3 and L1<br />Full details [here](../runtime/tests/tiledMatmul12/README.md) | 104 x 104   | dynamic    | Fixed  | ZigZag w/ [snitch compute core](https://github.com/EmilySillars/zigzag/blob/manual-examples/zigzag/inputs/hardware/snitch-cc-only-integers.yaml) | TODO      | TODO  |
